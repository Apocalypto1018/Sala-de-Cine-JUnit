	...
	do {
	  ...
	  switch (opc) {
		...
		case 1: {
		  ...
		  sala.agregarPelicula(Titulo, Genero, Director, Protagonista, edad, Nacionalidad, sexo);
		...
		case 3:{
                    System.out.println("La cantidad de mujeres actrices es: "+sala.ActricesMujeres());
                    break;
                }
